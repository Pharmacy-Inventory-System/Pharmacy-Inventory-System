...
public class Generate_Reports extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(Generate_Reports.class.getName());
    ...
    private void initComponents() {
        ...
        report_type.setText("Report Type:");

        combobox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Inventory Summary", " " }));
